...
class _MapsWidgetState extends State<MapsWidget> {
  ...
  bool inputaddressFocusListenerRegistered = false;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<GooglemapsRecord>>(
      stream: queryGooglemapsRecord(),
      builder: (context, snapshot) {
        ...
        List<GooglemapsRecord> mapsGooglemapsRecordList = snapshot.data!;
                      ...
                      Align(
                        ...
                        child: FlutterFlowGoogleMap(
                          ...
                          initialLocation: _model.googleMapsCenter ??=
                              FFAppState().location!,
                          markers: mapsGooglemapsRecordList
                              .map(
                                                  ...
                                                  child: Autocomplete<String>(
                                                    ...
                                                    fieldViewBuilder: (
                                                      ...
                                                      _model.inputaddressFocusNode =
                                                          focusNode;
                                                      if (!inputaddressFocusListenerRegistered) {
                                                        inputaddressFocusListenerRegistered =
                                                            true;
                                                        _model
                                                            .inputaddressFocusNode!
                                                            .addListener(
                                                          () async {
                                                            _model.apiResultx2l =
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return AlertDialog(
                                                                    title: Text(
                                                                        'API Calls Failed'),
                                                                    content: Text(
                                                                        'There is something wrong with your action'),
                                                                    actions: [
                                                                      TextButton(
                                                                        onPressed:
                                                                            () =>
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await currentUserReference!
                                ...
                                displayMap: _model.googleMapsCenter,
                              ));

                              await currentUserReference!
                                  .update(createUsersRecordData(
                                displayMapName: _model.lokasiuser.firstOrNull,
                              ));

                              context.pushNamed(
                                HomeFixWidget.routeName,
                                queryParameters: {
                                  'receivemaps': serializeParam(
